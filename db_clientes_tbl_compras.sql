...
CREATE TABLE `tbl_compras` (
  ...
  KEY `idCurso` (`idCurso`),
  CONSTRAINT `tbl_compras_ibfk_1` FOREIGN KEY (`idCliente`) REFERENCES `tbl_clientes` (`id`)
...
INSERT INTO `tbl_compras` VALUES (1,'2020-04-12',2,1),(2,'2020-03-25',4,8),(3,'2020-04-01',3,7),(4,'2020-04-12',3,8),(5,'2020-04-12',4,10);
